...
namespace HelloConsoleEF
{
    class Program
    {
        ...
        static void PrikaziGradove()
        {
            using (var context = new ProbaContext())
            {
                var listaGrad = context.Grad;
                foreach (var g in listaGrad)
                {
        ...
        static void PrikaziMeni()
        {
            ...
            Console.WriteLine("1. Prikaz podataka o svim skolama");
            Console.WriteLine("2. Prikaz podataka o skolama iz datog grada");
            Console.WriteLine("3. Dodavanje grada");
