package p02Tcp.p05TcpSocketSerialization;
...
class Point2d implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8108504290378418214L;
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Distance from " + pt1 + " to " + pt2 + " is "
				+ pt1.distanceFrom(pt2));

		System.out.println("Distance from " + pt2 + " to " + pt1 + " is "
