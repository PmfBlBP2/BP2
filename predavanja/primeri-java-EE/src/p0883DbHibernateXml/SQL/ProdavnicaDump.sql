...
CREATE TABLE `proizvod` (
  ...
  `JedinicaMjere` varchar(45) DEFAULT NULL,
...
INSERT INTO `proizvod` VALUES (1,'Cokolada',300,'komad'),(3,'Mleko',400,'l'),(4,'Hleb',900,'kg'),(6,'Pivo',1000,'flasa'),(7,'Ulje',200,'litar');
...
-- Dump completed on 2014-05-21 22:28:03
