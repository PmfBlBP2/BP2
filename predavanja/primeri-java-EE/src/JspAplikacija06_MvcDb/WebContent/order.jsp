...
<%@page session="true" import="java.util.*,controler.*,model.*"%>
<!DOCTYPE html>
<html>
<head>
	...
	<form name="AddForm" action="shopping" method="POST">
		<input type="hidden" name="todo" value="add"> Select Book: <select
			...
			<%
				...
				{
					int bookId = books.getIdByPosition(i+1);
					out.println("<option value='" + bookId + "'>");
					out.println(books.getTitleById(bookId) + " | " + books.getAuthorById(bookId) + " | "
